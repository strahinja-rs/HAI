...
## Concepts to Create (via retrieval exercise next session)
- Interpretability Layers (user-facing vs mechanistic — two layers of the same problem)
- Intent Expression Atrophy (expression as constitutive of intent, self-reinforcing cycle)
- Friction Discernment (meta-skill of choosing where to keep/remove friction)
- The Interaction Field (human-AI interaction as a single entity, not two separate ones)
- Possibly: AI Whisperers, Stochastic Epistemology — depending on how they develop
